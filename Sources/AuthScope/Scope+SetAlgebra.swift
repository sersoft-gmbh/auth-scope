extension Scope: SetAlgebra {
    ...
    public __consuming func union(_ other: __owned Scope) -> Scope {
        return Scope(accessRanges: accessRanges.union(other.accessRanges))
    }
    ...
    public __consuming func intersection(_ other: Scope) -> Scope {
        return Scope(accessRanges: accessRanges.intersection(other.accessRanges))
    }
    ...
    public __consuming func symmetricDifference(_ other: __owned Scope) -> Scope {
        return Scope(accessRanges: accessRanges.symmetricDifference(other.accessRanges))
    }
    ...
    public mutating func insert(_ newMember: __owned Element) -> (inserted: Bool, memberAfterInsert: Element) {
        return accessRanges.insert(newMember)
    }

    @inlinable
    @discardableResult
    public mutating func update(with newMember: __owned Element) -> Element? {
        return accessRanges.update(with: newMember)
    }

    @inlinable
    @discardableResult
    public mutating func remove(_ member: Element) -> Element? {
        return accessRanges.remove(member)
    }
}
